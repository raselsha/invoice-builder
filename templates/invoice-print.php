...
<style>
	* { box-sizing: border-box; margin: 0; padding: 0; }
	...
	/* Status ribbon */
	.inv-status-bar {
		background: <?php echo esc_attr( $date_color ); ?>;
		padding: 10px 48px;
		display: flex;
		gap: 32px;
		font-size: 12px;
		color: <?php echo esc_attr( $date_text_muted ); ?>;
	}
	...
	.totals-row.grand-total {
		border-bottom: none;
		border-top: 2px solid <?php echo esc_attr( $header_color ); ?>;
		margin-top: 6px;
		padding-top: 12px;
		font-size: 18px;
		font-weight: 800;
	...
	.inv-terms-label { font-weight: 700; color: #1e293b; margin-bottom: 10px; text-transform: uppercase; font-size: 11px; letter-spacing: .06em; }
	.inv-terms ol {
		margin: 0;
		padding-left: 18px;
		color: #64748b;
	...
	.inv-terms ol li { margin-bottom: 4px; }
	.inv-terms ol li:last-child { margin-bottom: 0; }
	/* Footer */
	.inv-footer {
		background: #f8f9fc;
		padding: 20px 48px;
...
<div class="no-print" style="text-align:center;margin-bottom:20px">
	<button onclick="window.print()"
		style="background:<?php echo esc_attr( $primary_color ); ?>;color:#fff;border:none;padding:10px 28px;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer">
		🖨 Print / Save as PDF
	</button>
